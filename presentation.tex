...
\begin{frame}{Preprocessing Pipeline (cont.)}
    \textbf{Visualization:}
\begin{center}
\includegraphics[width=0.8\textwidth]{figures/PP_pipeline.png}
\end{center}
\end{frame}

% ---- Slide 7: Methodology -- Traditional Models ----
\begin{frame}{Methodology: Traditional Models}
\textbf{Seven models evaluated:} RF, SVM, GB, DT (CART + C5.0), $k$-NN, ELM, MLP.
...
\begin{itemize}
    ...
    \item $k$-NN: baseline to test if simple distance-based methods suffice
\end{itemize}
...
\textbf{Evaluation metrics:} Balanced Accuracy, Macro F1-score.
\begin{center}
\includegraphics[width=0.8\textwidth]{code/plots/combined_tradml_llm_performance.png}
\end{center}
\end{frame}
